...
namespace SpartanProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Popular empty: " + (comp2.PopularCath().Type() == "sprint" ? "OK" : "WRONG"));
            bool l;
            Competitor winner;
            ...
            Console.WriteLine("Popular 1: " + (comp2.PopularCath().Type() == "sprint" ? "OK" : "WRONG"));
            (l, winner) = comp2.Winner(Sprint.Instance(), true);
            ...
            Console.WriteLine("Popular super: " + (comp2.PopularCath().Type() == "super" ? "OK" : "WRONG"));
